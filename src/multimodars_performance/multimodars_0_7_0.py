...
from mm_perf import timing_decorator, PATH_TEST_DATA
...
os.chdir(os.path.join(PATH_TEST_DATA, "NARCO_5"))

# preprocessing of the centerlines ##################################################
...
n_vertices = len(results["mesh"].vertices)
